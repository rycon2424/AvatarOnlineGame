...
public class RockCrush : RaycastBased
{
    ...
    public void Crush()
    {
        ...
        _spawnedCrusherL.Fired(_damage, _closeSpeed, _distanceBetweenRocks/2 , _playerCombat._playerController);
        _spawnedCrusherR.Fired(_damage, _closeSpeed, _distanceBetweenRocks/2 , _playerCombat._playerController);
    }
}
